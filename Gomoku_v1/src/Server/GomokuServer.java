...
class Game {
    ...
    public synchronized boolean legalMove(int location, Player player) {
        if (player == currentPlayer && board[location] == null) {
            ...
            for (int i=1; i<currentPlayer.nPlayer;i++){
              ...
              currentPlayer.otherPlayerMoved(location, mark, tempPlayer.mark);
            }
    ...
    */
    ...
    class Player extends Thread {
         ...
         */
        public void otherPlayerMoved(int location, char mark, char nextMark) {
            output.println("OPPONENT_MOVED " + mark + nextMark + location);
            output.println(
                ...
                while (true) {
                    ...
                    if (command.startsWith("MOVE")) {
                        ...
                        if (legalMove(location, this)) {
                            output.println("VALID_MOVE "+opponent.mark);
                            //System.out.println("VALID_MOVE "+opponent.mark);
